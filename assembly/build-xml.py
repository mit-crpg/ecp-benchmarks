"""This script creates an infinitely long fuel assembly with reflective
...
# A list of the assembly types in BEAVRS
assembly_names = ['Fuel 1.6% enr no instr RCCA SB',
                  'Fuel 1.6% enr instr RCCA C',
                  'Fuel 1.6% enr instr RCCA B',
                  'Fuel 1.6% enr instr RCCA SE',
                  'Fuel 1.6% enr instr RCCA SC',
                  'Fuel 1.6% enr instr RCCA SD',
                  'Fuel 1.6% enr no instr RCCA SC',
                  'Fuel 1.6% enr instr RCCA A',
                  'Fuel 1.6% enr instr RCCA SB',
                  'Fuel 1.6% enr no instr RCCA D',
                  'Fuel 1.6% enr no instr RCCA C',
                  'Fuel 1.6% enr no instr RCCA SE',
                  'Fuel 1.6% enr no instr RCCA A',
                  'Fuel 1.6% enr no instr RCCA SD',
                  'Fuel 1.6% enr instr no BAs',
                  'Fuel 1.6% enr no instr RCCA B',
                  'Fuel 1.6% enr no instr no BAs',
                  'Fuel 2.4% enr instr 16',
                  'Fuel 2.4% enr instr RCCA D',
                  'Fuel 2.4% enr instr 12',
                  'Fuel 2.4% enr no instr 16',
                  'Fuel 2.4% enr no instr RCCA D',
                  'Fuel 2.4% enr no instr 12',
                  'Fuel 3.1% enr no instr 6S',
                  'Fuel 3.1% enr no instr 6W',
                  'Fuel 3.1% enr instr 6E',
                  'Fuel 3.1% enr no instr 15SE',
                  'Fuel 3.1% enr instr RCCA SA',
                  'Fuel 3.1% enr no instr 6N',
                  'Fuel 3.1% enr instr 20',
                  'Fuel 3.1% enr no instr 15SW',
                  'Fuel 3.1% enr no instr 6E',
                  'Fuel 3.1% enr instr no BAs',
                  'Fuel 3.1% enr no instr no BAs',
                  'Fuel 3.1% enr no instr 20',
                  'Fuel 3.1% enr no instr RCCA SA',
                  'Fuel 3.1% enr no instr 15NW',
                  'Fuel 3.1% enr no instr 16',
                  'Fuel 3.1% enr instr 6S',
                  'Fuel 3.1% enr instr 6N',
                  'Fuel 3.1% enr instr 15NE']
