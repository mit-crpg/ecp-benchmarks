...
plenumSpringOR  = 0.06459  # frapcon source - see catawba_spring.ods
...
## <!--- axials copied straight from axials_catawba.ods
...
topActiveCore        =    218.887  # bottomFuelStack + activeCoreHeight
botBurnAbs           =     41.087  # approx from seabrook NDR of 1.987in for space between bot of BAs and bot of active fuel
   
# from Watts Bar Unit 2 safety analysis report   
topFuelRod           =    223.272  # fig 4.2-3 from Watts Bar Unit 2 safety analysis report
topPlenum            =    221.223  # fig 4.2-3 from Watts Bar Unit 2 safety analysis report
bottomUpperNozzle    =    226.617  # fig 4.2-3 from Watts Bar Unit 2 safety analysis report
topUpperNozzle       =    235.444  # fig 4.2-3 from Watts Bar Unit 2 safety analysis report
                       
highestExtent        =    255.444  # arbitrary amount of water above core
...
neutronShieldOR    = 92.0 # coreBarrelOR+2 find real number    TODO
...
def write_materials(mats,outFile):
  ...
  outStr += "<materials>\n"
  outStr += "\n"
  outStr += comm_t.format("This file auto-generated by seabrook.py")
  outStr += "\n"
  outStr += "\n"
...
def write_cmfd(cmfd,outFile):
  ...
  outStr += "<cmfd>\n"
  outStr += "\n"
  outStr += comm_t.format("This file auto-generated by catawba.py")
  outStr += "\n"
